export default function Header({ lang, setLang }) {
    return (
        <header className="h-28 w-full flex items-center justify-center bg-white md:h-20">
            <div className="flex gap-[70px] xl:gap-12 lg:gap-8 px-16 md:px-6 sm:px-2 w-full">
                ...
                <div className="flex w-full justify-between items-center gap-3">
                    ...
                    <div className="relative w-full h-full before:content-[''] before:absolute before:top-[40%] before:left-0 before:border-t-[5px] before:bg-black before:w-full before:border-black md:hidden"></div>
                    <div className="bg-arrow-right h-[26px] min-w-[24px] bg-no-repeat bg-contain bg-center md:hidden"></div>
